...
if [ "$1" == "debug" ]; then
  ...
  --jars /build/extra_jars/*,/s3datasource/target/scala-2.12/s3datasource_2.12-0.1.0.jar,/build/downloads/h2-1.4.200.jar \
...
#  --jars /build/extra_jars/*,/s3datasource/target/scala-2.12/s3datasource_2.12-0.1.0.jar,/build/h2-latest.jar \
fi
