...
if [ ${DEBUG} == "YES" ]; then
  ...
  --conf "spark.driver.extraJavaOptions=-classpath /conf/:/build/spark-3.1.2/jars/*:/examples/scala/target/scala-2.12/ -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=172.169.1.41:5006" \
