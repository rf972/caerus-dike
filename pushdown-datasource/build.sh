...
cp $SPARK_TEST_JAR_DIR/sql/core/target/spark-sql_2.12-3.1.2-tests.jar pushdown-datasource/lib
cp $SPARK_TEST_JAR_DIR/sql/catalyst/target/spark-catalyst_2.12-3.1.2-tests.jar pushdown-datasource/lib
cp $SPARK_TEST_JAR_DIR/core/target/spark-core_2.12-3.1.2-tests.jar pushdown-datasource/lib
