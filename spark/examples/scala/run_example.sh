...
if [ "$1" == "-d" ]; then
  ...
  --conf "spark.driver.extraJavaOptions=-classpath /conf/:/build/spark-3.1.2/jars/*:/examples/scala/target/scala-2.12/ -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=10.124.48.63:5006" \
  --packages org.json:json:20210307,com.github.scopt:scopt_2.12:4.0.0-RC2,org.apache.thrift:libthrift:0.13.0  \
